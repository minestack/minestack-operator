...
func (r *MinecraftServerDeployment) ValidateUpdate(old runtime.Object) error {
	...
	oldMSG := old.(*MinecraftServerDeployment)

	// all validation from create

	if equality.Semantic.DeepEqual(oldMSG.Spec.Selector.MatchLabels, r.Spec.Selector.MatchLabels) == false {
		// TODO: error about can't change labels
	}
